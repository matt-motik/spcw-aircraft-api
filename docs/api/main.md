...
<div id="load_initial_countries"></div>

## load_initial_countries

**Тип:** function

**Кратко:** Загружает начальные данные по 4+ странам.
...
<div id="show_statistics"></div>

## show_statistics

**Тип:** function

**Кратко:** Показывает статистику по самолетам.
...
<div id="choose_storage"></div>

## choose_storage

**Тип:** function

**Кратко:** Выбор хранилища пользователем.
